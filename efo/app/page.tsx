  ...
  return (
    <main className={`flex min-h-screen flex-col items-center justify-between ${cooper.className}`}>
      ...
      <div className="flex-1 h-full w-full bg-[url('/background.jpg')] bg-cover flex items-center justify-center">
        <div className='flex flex-col p-8 bg-neutral-900/70 backdrop-blur-md space-y-8 max-w-[700px] rounded-2xl items-center justify-center'>
        ...
        <div className='flex flex-col p-8 bg-neutral-900/70 backdrop-blur-md space-y-16 max-w-[750px] rounded-2xl absolute right-8 bottom-8'>
        <div className='flex items-center justify-center space-x-8'>
          <span className='text-red-500'>Hier geht&apos;s zu unserem Schwesterverein:<br/> Eisenbahnfreunde Grenzland eV</span>
